...
public abstract class AbstractHandlerMapping extends WebApplicationObjectSupport
	 ...
	 * @see #getHandlerInternal
	 * 实现了【获得请求对应的处理器和拦截器们】的骨架逻辑，
	 * 而暴露 #getHandlerInternal(HttpServletRequest request) 抽象方法，
	 * 交由子类实现。这就是我们常说的“模板方法模式” 。
	 */
	@Override
	@Nullable
	 ...
	 * 但是重心在于从 adaptedInterceptors 中，获得请求路径对应的符合的 HandlerInterceptor 数组。实际上，只有 MappedInterceptor 类型的拦截器，需要进行匹配。
	 */
